...
public abstract class ActiveRouter extends MessageRouter {
	 ...
	 * @param messages The tuples to try
	 ...
	 */
	protected Tuple<Message, Connection> tryMessagesForConnected(List<Tuple<Message, Connection>> messages) {
	if (messages.size() == 0) {
		return null;
	}
...
//                connections1 = connections.toArray(connections1);
	...
	protected Connection exchangeDeliverableMessages() {
        ...
        RoutingUtils.tryMessagesForConnected(this, sortByQueueMode(getMessagesForConnected()));

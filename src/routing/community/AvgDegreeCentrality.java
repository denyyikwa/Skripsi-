...
public class AvgDegreeCentrality implements Centrality
{
	...
	public double[] getGlobal(Map<DTNHost, List<Duration>> connHistory) {
		...
		throw new UnsupportedOperationException("Unimplemented method 'getGlobal'");
	}

	@Override
	public List<Double> getGlobalPopularity() {
		// TODO Auto-generated method stub
		throw new UnsupportedOperationException("Unimplemented method 'getGlobalPopularity'");
	}
